...
import Invoker from '../js/invoker';
import UI from '../js/ui';
import action from '../js/action';
import commandFactory from '../js/factory/command';
import Graphics from '../js/graphics';
import { makeSelectionUndoData, makeSelectionUndoDatum } from '../js/helper/selectionModifyHelper';
import { sendHostName, getObjectType } from '../js/util';
import {
