...
import templateHtml from '../../js/ui/template/submenu/draw';
import { assignmentForDestroy, getRgb } from '../../js/util';
import { defaultDrawRangeValues, eventNames, selectorNames } from '../../js/consts';
