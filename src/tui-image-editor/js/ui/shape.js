...
import templateHtml from '../../js/ui/template/submenu/shape';
import { toInteger, assignmentForDestroy } from '../../js/util';
import { defaultShapeStrokeValues, eventNames, selectorNames } from '../../js/consts';
