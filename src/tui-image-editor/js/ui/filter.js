...
import Colorpicker from '../../js/ui/tools/colorpicker';
import Range from '../../js/ui/tools/range';
import Submenu from '../../js/ui/submenuBase';
import templateHtml from '../../js/ui/template/submenu/filter';
import { toInteger, toCamelCase, assignmentForDestroy } from '../../js/util';
import { defaultFilterRangeValues as FILTER_RANGE, eventNames, selectorNames } from '../../js/consts';
