...
import templateHtml from '../../js/ui/template/submenu/text';
import { assignmentForDestroy } from '../../js/util';
import { defaultTextRangeValues, eventNames, selectorNames } from '../../js/consts';
