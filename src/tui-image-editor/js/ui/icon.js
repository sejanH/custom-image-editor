...
import templateHtml from '../../js/ui/template/submenu/icon';
import { isSupportFileApi, assignmentForDestroy } from '../../js/util';
import { defaultIconPath, eventNames, selectorNames } from '../../js/consts';
