...
import templateHtml from '../../js/ui/template/submenu/resize';
import { assignmentForDestroy, toInteger } from '../../js/util';
import Range from '../../js/ui/tools/range';
import { defaultResizePixelValues } from '../../js/consts';
