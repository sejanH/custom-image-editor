...
import { getSelector, assignmentForDestroy, cls, getHistoryTitle, isSilentCommand } from '../js/util';
import {
  ZOOM_HELP_MENUS,
  COMMAND_HELP_MENUS,
  DELETE_HELP_MENUS,
...
import mainContainer from '../js/ui/template/mainContainer';
import controls from '../js/ui/template/controls';

import Theme from '../js/ui/theme/theme';
import Shape from '../js/ui/shape';
import Crop from '../js/ui/crop';
import Resize from '../js/ui/resize';
import Flip from '../js/ui/flip';
import Rotate from '../js/ui/rotate';
import Text from '../js/ui/text';
import Mask from '../js/ui/mask';
import Icon from '../js/ui/icon';
import Draw from '../js/ui/draw';
import Filter from '../js/ui/filter';
import History from '../js/ui/history';
import Locale from '../js/ui/locale/locale';
