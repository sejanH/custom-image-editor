...
import ImageLoader from '../js/component/imageLoader';
import Cropper from '../js/component/cropper';
import Flip from '../js/component/flip';
import Rotation from '../js/component/rotation';
import FreeDrawing from '../js/component/freeDrawing';
import Line from '../js/component/line';
import Text from '../js/component/text';
import Icon from '../js/component/icon';
import Filter from '../js/component/filter';
import Shape from '../js/component/shape';
import Zoom from '../js/component/zoom';
import CropperDrawingMode from '../js/drawingMode/cropper';
import FreeDrawingMode from '../js/drawingMode/freeDrawing';
import LineDrawingMode from '../js/drawingMode/lineDrawing';
import ShapeDrawingMode from '../js/drawingMode/shape';
import TextDrawingMode from '../js/drawingMode/text';
import IconDrawingMode from '../js/drawingMode/icon';
import ZoomDrawingMode from '../js/drawingMode/zoom';
import {
  makeSelectionUndoData,
  makeSelectionUndoDatum,
  setCachedUndoDataForDimension,
} from '../js/helper/selectionModifyHelper';
import { getProperties, includes, isShape, stamp } from '../js/util';
import {
...
import Resize from '../js/component/resize';
import ResizeDrawingMode from '../js/drawingMode/resize';
